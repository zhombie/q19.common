 ...
 *    GitHub: https://github.com/franmontiel/LocaleChanger
 *
...
import kz.q19.common.locale.matcher.LanguageMatchingAlgorithm
import kz.q19.common.locale.matcher.MatchingAlgorithm
import kz.q19.common.locale.utils.SystemLocaleRetriever.retrieve
import java.util.*
...
object LocaleManager {
    ...
    private fun getDelegate(): LocaleManagerDelegate {
        return checkNotNull(delegate) { "LocaleManager is not initialized. Please first call LocaleManager.initialize" }
    }
